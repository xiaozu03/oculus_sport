...
namespace oculus_sport.Services
{
    public interface IBookingService
    {
        ...
        /// </summary>
        Task<string> CalculateFinalCostAsync(string facilityId, string timeSlot, string studentId); // <--- ERROR FIX
        ...
        /// </summary>
        Task<bool> UpdateBookingStatusAsync(Booking booking, string newStatus); // <--- ERROR FIX
    }
}